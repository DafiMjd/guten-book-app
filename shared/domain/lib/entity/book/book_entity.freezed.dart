...
mixin _$BookEntity {
 ...
 int get id; String get title; List<AuthorEntity> get authors; List<String> get summaries; List<dynamic> get translators; List<String> get subjects; List<String> get bookshelves; List<String> get languages; bool get copyright; String get mediaType; int get downloadCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,const DeepCollectionEquality().hash(authors),const DeepCollectionEquality().hash(summaries),const DeepCollectionEquality().hash(translators),const DeepCollectionEquality().hash(subjects),const DeepCollectionEquality().hash(bookshelves),const DeepCollectionEquality().hash(languages),copyright,mediaType,downloadCount);

@override
String toString() {
  return 'BookEntity(id: $id, title: $title, authors: $authors, summaries: $summaries, translators: $translators, subjects: $subjects, bookshelves: $bookshelves, languages: $languages, copyright: $copyright, mediaType: $mediaType, downloadCount: $downloadCount)';
}
...
@useResult
$Res call({
 int id, String title, List<AuthorEntity> authors, List<String> summaries, List<dynamic> translators, List<String> subjects, List<String> bookshelves, List<String> languages, bool copyright, String mediaType, int downloadCount
});
...
/// Create a copy of BookEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? authors = null,Object? summaries = null,Object? translators = null,Object? subjects = null,Object? bookshelves = null,Object? languages = null,Object? copyright = null,Object? mediaType = null,Object? downloadCount = null,}) {
...
as List<dynamic>,subjects: null == subjects ? _self.subjects : subjects // ignore: cast_nullable_to_non_nullable
